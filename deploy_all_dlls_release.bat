@echo off
echo ============================================
echo  TCHub - Copie complete des DLL (Qt + Poppler) - RELEASE
echo ============================================
echo.
...
set OUTPUT_DIR=C:\Dev\TCHub\x64\Release
...
"%QT_PATH%\bin\windeployqt.exe" --release --no-translations TCHub.exe
